...
<head>
  ...
  <title>Activate Your SPHERE Account</title>
  <style>
    ...
    .em-btn { display: inline-block; background: #1a1a1a; color: #ffffff !important; text-decoration: none; padding: 11px 28px; border-radius: 4px; font-size: 13.5px; font-weight: 500; letter-spacing: 0.02em; }
...
<body>
  <div class="em-wrap">
    ...
    <div class="em-body">
      ...
      <p class="em-text">
        Your SPHERE account has been created by an administrator. Please click the button below to set your password and activate your account.
      </p>
      ...
      <div class="em-btn-wrap">
        <a href="{{ $setPasswordUrl }}" class="em-btn">Set My Password</a>
      </div>
      ...
      <div class="em-notice">
        ...
        <p>This link is only valid for <strong>24 hours</strong>. Please activate your account promptly.</p>
      </div>

      <p class="em-text" style="margin-bottom: 8px;">
        If the button above does not work, copy and paste the following URL into your browser:
      </p>
      <span class="em-url">{{ $setPasswordUrl }}</span>

      <hr class="em-divider">

      <p class="em-small">
        If you did not request this account or have any questions, please ignore this email or contact your system administrator.
      </p>
    </div>
