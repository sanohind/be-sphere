...
class DashboardController extends Controller
{
        ...
        if ($user->isSuperadmin()) {
            $projects = [
                ...
                [
                    ...
                    'url' => env('ARRIVAL_DASHBOARD_URL', 'http://ams.ns1.sanoh.co.id/#/arrival-dashboard'),
                    // 'url' => env('AMS_URL', 'http://localhost:5174/#/'),
                    'icon' => 'arrival',
                    'color' => 'green',
                    'permissions' => ['read'],
                ...
                [
                    ...
                    'url' => env('ARRIVAL_CHECK_URL', 'http://ams.ns1.sanoh.co.id/#/driver'),
                    // 'url' => env('AMS_URL', 'http://localhost:5174/#/'),
                    'icon' => 'driver',
                    'color' => 'yellow',
                    'permissions' => ['read'],
                ...
                [
                    ...
                    // 'url' => env('AMS_URL', 'http://localhost:5175/#/'),
                    'icon' => 'box',
                    'color' => 'purple',
                    'permissions' => ['read', 'write', 'admin'],
                ],
            ...
            $departmentProjects = [
                'WH' => [ // Warehouse department
                    ...
                    [
                        ...
                        'description' => 'Arrival Dashboard for public access',
                        'url' => env('ARRIVAL_DASHBOARD_URL', 'http://ams.ns1.sanoh.co.id/#/arrival-dashboard'),
                        // 'url' => env('ARRIVAL_DASHBOARD_URL', 'localhost:5174'),
                        'icon' => 'arrival',
                        'color' => 'green',
                        'permissions' => ['read'],
                    ],
                    [
                        ...
                        'description' => 'Arrival Check for driver',
                        'url' => env('ARRIVAL_CHECK_URL', 'http://ams.ns1.sanoh.co.id/#/driver'),
                        // 'url' => env('ARRIVAL_CHECK_URL', 'localhost:5174'),
                        'icon' => 'driver',
                        'color' => 'yellow',
                        'permissions' => ['read'],
                    ],
                    [
                        ...
                        'description' => 'Inventory and Warehouse management',
                        'url' => env('SCOPE_URL', 'https://scope.sanohindonesia.co.id'),
                        // 'url' => env('SCOPE_URL', 'localhost:5175'),
                        'icon' => 'box',
                        'color' => 'purple',
                        'permissions' => $user->isAdmin() ? ['read', 'write'] : ['read'],
                    ],
    ...
    public function getProjectUrl(string $projectId): JsonResponse
    {
        ...
        $projectUrls = [
            ...
            // 'arrival-dashboard' => env('ARRIVAL_DASHBOARD_URL', 'localhost:5174'),
            'arrival-check' => env('ARRIVAL_CHECK_URL', 'http://ams.ns1.sanoh.co.id/#/driver'),
            // 'arrival-check' => env('ARRIVAL_CHECK_URL', 'localhost:5174'),
            'scope' => env('SCOPE_URL', 'https://scope.sanohindonesia.co.id'),
            // 'scope' => env('SCOPE_URL', 'localhost:5175'),
        ];
